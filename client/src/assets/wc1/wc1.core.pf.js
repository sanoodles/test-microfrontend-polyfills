...
(function(s){s&&(resourcesUrl=s.getAttribute('data-resources-url'))})(document.querySelector("script[data-namespace='wc1']"));
...
})(window,document,{},"wc1","hydrated",[["wc-one","wc-one",1,[["first",1,0,1,2],["last",1,0,1,2],["middle",1,0,1,2]],1]]);