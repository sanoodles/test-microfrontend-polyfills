...
(function(s){s&&(resourcesUrl=s.getAttribute('data-resources-url'))})(document.querySelector("script[data-namespace='wc3']"));
...
function createPlatformMainLegacy(namespace, Context, win, doc, resourcesUrl, hydratedCssClass, components, customStyle) {
  ...
  (true, true) && domApi.$supportsShadowDom && customStyle && console.error('Unsupported browser. Native shadow-dom available but CSS Custom Properites are not.');
  // set App Context
...
})(window,document,{},"wc3","hydrated",[["wc-three","wc-three",1,[["first",1,0,1,2],["last",1,0,1,2],["middle",1,0,1,2]],1]]);